...
public class Ex5_BasicMath {
	...
	public static void main(String[] args) {
		...
		System.out.println("The sum of x and y is: " + (z=x+y));
		
		// Set z to the difference of x and y
		
		System.out.println("The difference of x and y is: " + (z=x-y));
		
		// Set z to the product of x and y (multiply x by y)
		
		System.out.println("The product of x and y is: " + (z=x*y));
		
		// Set z to the quotient of x and y (divide x by y)
		
		System.out.println("The quotient of x and y is: " + (z=x/y));
		
		// Set z to the remainder of x divided by y
		// Hint remainder is found using the mod operator (%) i.e 6 % 3 is 0
		
		System.out.println("The remainder of x divided by y is: " + (z=x%y));
		...
		System.out.println("The quotient of a and b is: " + (c=a/b));
		
		
		// Set z equal to (x * 1.0) / y
		
		System.out.println("The result of x * 1.0 / y is: " + (z=(int) ((x*1.0)/y)));
	}
